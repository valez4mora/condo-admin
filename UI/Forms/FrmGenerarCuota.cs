...
namespace UI.Forms
{
    public partial class FrmGenerarCuota : Form
    {
        ...
        // Facade utilizado para centralizar las operaciones financieras.
        ...
        private void CargarPropiedades()
        {
            try
            {
                ...
                List<PropiedadDTO> propiedades = propiedadBLL
                    .ObtenerTodas()
                    .OrderBy(p => p.Codigo)
                    .ToList();
        ...
        private void cmbPropiedades_SelectedIndexChanged(
            object sender,
            EventArgs e)
        {
            if (cargando)
        ...
        private void MostrarVistaPrevia()
        {
            ...
            if (p == null)
            {
                lblDatosPropiedad.Text =
                    "Seleccione una propiedad para consultar sus datos.";
            ...
            decimal baseCuota = decimal.Round(
                (p.Area * p.TarifaMetro) + p.CargoFijo,
                2,
            ...
            lblCalculo.Text =
                "Cuota base: ₡" +
                baseCuota.ToString("N2") +
                "\nIVA (13 %): ₡" +
                iva.ToString("N2") +
                "\nTotal: ₡" +
                (baseCuota + iva).ToString("N2") +
                "\nFondo de reserva (10 %): ₡" +
                fondo.ToString("N2") +
            ...
            lblEstado.ForeColor =
                Color.FromArgb(39, 108, 174);
        }

        private void btnGenerarCuota_Click(
            object sender,
            EventArgs e)
        {
            ...
            if (propiedad == null)
            {
                Aviso("Debe seleccionar una propiedad.");
                return;
            }
            ...
            try
            {
                ...
                // La UI ahora utiliza el patrón Facade.
                cargoGenerado =
                    gestionFinanciera.GenerarCuotaOrdinaria(
                        propiedad);
                ...
                lblEstado.Text =
                    "Cuota guardada; pendiente de facturar";

                lblEstado.ForeColor =
                    Color.FromArgb(214, 137, 16);

                MessageBox.Show(
                    "Cuota generada correctamente. " +
                    "Ahora puede emitir la factura.",
                    "Cuota generada",
                    MessageBoxButtons.OK,
            ...
            EventArgs e)
        {
            ...
            {
                Aviso(
                    "Primero debe generar la cuota de la " +
            ...
            try
            {
                ...
                FacturaDTO factura =
                    facturaBLL.GenerarFacturaManual(
                        cargoGenerado,
                        propiedad.Codigo);
